...
echo "Building the Flutter web app with base href /pawsitivity/..."
flutter build web --release --base-href="/pawsitivity/" #change '/myappRepo/' to the name of the github repo of your project
